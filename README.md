# FoodscapeLA Dining Rating App

#### View Github Pages site [here](https://katyacano.github.io/milestone-project-3/)
#### View Heroku deployed app [here](https://flask-task-manager-project-kc.herokuapp.com/)  
...
- Interactive elements- Search bar, dining spots library, sign-up form, log in/ log out actions, log a new spot form.
